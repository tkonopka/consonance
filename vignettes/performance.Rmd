...
the x-axis. The results show that processing a non-problematic dataset is
fast compared to detecting errors. The infrastructure provided by
`consonance` slows it down compared to base R, but performance seems
competitive compared to the `assertr` framework.
